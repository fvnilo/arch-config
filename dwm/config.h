...
/* tagging */
static const char *tags[] = { "¹", "Ç", "Ú", "Ë", "ª", "à", "º" };

static const Rule rules[] = {
	/* class          instance    title       tags mask     isfloating   monitor */
	{ "Chromium",     NULL,       NULL,       1 << 2,       False,       -1 },
	{ "sublime-text", NULL,       NULL,       1 << 1,       False,       -1 },
        { "Audacious",    NULL,       NULL,       1 << 5,       False,       -1 },
...
static int changekblayout(const Arg *arg);
